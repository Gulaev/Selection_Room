...
export declare class NumberInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
  ...
  */
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NumberInputComponent, "smart-number-input, [smart-number-input]", ["smart-number-input"], { "animation": "animation"; "disabled": "disabled"; "inputPurpose": "inputPurpose"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "max": "max"; "messages": "messages"; "min": "min"; "name": "name"; "numberFormat": "numberFormat"; "placeholder": "placeholder"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "step": "step"; "theme": "theme"; "unfocusable": "unfocusable"; "value": "value"; }, { "onChange": "onChange"; }, never>;
}
