...
class RadioButtonComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
export { RadioButtonComponent, RadioButtonModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-radiobutton.mjs.map
