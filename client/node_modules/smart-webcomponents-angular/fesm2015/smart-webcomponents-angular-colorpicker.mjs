...
class ColorPickerComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
export { ColorPickerComponent, ColorPickerModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-colorpicker.mjs.map
