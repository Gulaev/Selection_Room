...
class ProgressBarComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
class CircularProgressBarComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /** @description This event is triggered when the value is changed.
...
export { CircularProgressBarComponent, ProgressBarComponent, ProgressBarModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-progressbar.mjs.map
