...
export declare class ColumnPanelComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    *  @param event. The custom event. 	*/
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ColumnPanelComponent, "smart-column-panel, [smart-column-panel]", ["smart-column-panel"], { "animation": "animation"; "dataSource": "dataSource"; "disabled": "disabled"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "messages": "messages"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "unfocusable": "unfocusable"; }, { "onApply": "onApply"; "onCancel": "onCancel"; }, never>;
}
