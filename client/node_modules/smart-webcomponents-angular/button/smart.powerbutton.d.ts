...
export declare class PowerButtonComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    *  @param event. The custom event. 	*/
    ...
    private unlisten;
    static ɵfac: i0.ɵɵFactoryDeclaration<PowerButtonComponent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<PowerButtonComponent, "smart-power-button, [smart-power-button]", ["smart-power-button"], { "animation": "animation"; "checked": "checked"; "clickMode": "clickMode"; "disabled": "disabled"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "messages": "messages"; "name": "name"; "readonly": "readonly"; "theme": "theme"; "unfocusable": "unfocusable"; "value": "value"; }, { "onChange": "onChange"; }, never>;
}
