...
class SortPanelComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
export { Smart, SortPanelComponent, SortPanelModule };
//# sourceMappingURL=smart-webcomponents-angular-sortpanel.mjs.map
