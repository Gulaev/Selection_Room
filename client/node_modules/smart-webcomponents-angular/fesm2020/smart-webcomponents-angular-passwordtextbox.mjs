...
class PasswordTextBoxComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
export { PasswordTextBoxComponent, PasswordTextBoxModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-passwordtextbox.mjs.map
