...
class ButtonGroupComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
export { ButtonGroupComponent, ButtonGroupModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-buttongroup.mjs.map
