...
class ValidatorComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        this.nativeElement = ref.nativeElement;
...
export { Smart, ValidatorComponent, ValidatorModule };
//# sourceMappingURL=smart-webcomponents-angular-validator.mjs.map
