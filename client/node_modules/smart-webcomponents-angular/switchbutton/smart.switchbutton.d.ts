...
export declare class SwitchButtonComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<SwitchButtonComponent, "smart-switch-button, [smart-switch-button]", ["smart-switch-button"], { "animation": "animation"; "clickMode": "clickMode"; "checked": "checked"; "disabled": "disabled"; "falseContent": "falseContent"; "falseTemplate": "falseTemplate"; "indeterminate": "indeterminate"; "inverted": "inverted"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "messages": "messages"; "name": "name"; "orientation": "orientation"; "readonly": "readonly"; "trueContent": "trueContent"; "trueTemplate": "trueTemplate"; "switchMode": "switchMode"; "theme": "theme"; "unfocusable": "unfocusable"; "value": "value"; }, { "onChange": "onChange"; "onCheckValue": "onCheckValue"; "onUncheckValue": "onUncheckValue"; }, never>;
}
