...
export declare class TreeItemsGroupComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TreeItemsGroupComponent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<TreeItemsGroupComponent, "smart-tree-items-group, [smart-tree-items-group]", ["smart-tree-items-group"], { "disabled": "disabled"; "expanded": "expanded"; "label": "label"; "level": "level"; "selected": "selected"; "separator": "separator"; "value": "value"; "readonly": "readonly"; }, {}, never>;
}
