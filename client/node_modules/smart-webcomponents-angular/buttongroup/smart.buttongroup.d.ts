...
export declare class ButtonGroupComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ButtonGroupComponent, "smart-button-group, [smart-button-group]", ["smart-button-group"], { "animation": "animation"; "dataSource": "dataSource"; "selectionMode": "selectionMode"; "disabled": "disabled"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "messages": "messages"; "name": "name"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "theme": "theme"; "selectedValues": "selectedValues"; "selectedIndexes": "selectedIndexes"; "unfocusable": "unfocusable"; }, { "onChange": "onChange"; }, never>;
}
