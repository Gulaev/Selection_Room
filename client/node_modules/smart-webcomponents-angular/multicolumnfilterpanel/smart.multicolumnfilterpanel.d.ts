...
export declare class MultiColumnFilterPanelComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    *  @param event. The custom event. 	*/
    ...
    private unlisten;
    static ɵfac: i0.ɵɵFactoryDeclaration<MultiColumnFilterPanelComponent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<MultiColumnFilterPanelComponent, "smart-multi-column-filter-panel, [smart-multi-column-filter-panel]", ["smart-multi-column-filter-panel"], { "animation": "animation"; "closeButtonPosition": "closeButtonPosition"; "dataSource": "dataSource"; "disabled": "disabled"; "editorCallback": "editorCallback"; "editorPlaceholder": "editorPlaceholder"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "maxLevel": "maxLevel"; "messages": "messages"; "operator": "operator"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "unfocusable": "unfocusable"; "value": "value"; }, { "onApply": "onApply"; "onCancel": "onCancel"; "onCollapseAll": "onCollapseAll"; "onExpandAll": "onExpandAll"; }, never>;
}
