...
export declare class DateRangeInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<DateRangeInputComponent, "smart-date-range-input, [smart-date-range-input]", ["smart-date-range-input"], { "animation": "animation"; "dateFormat": "dateFormat"; "disabled": "disabled"; "dropDownButtonPosition": "dropDownButtonPosition"; "dropDownHeight": "dropDownHeight"; "dropDownWidth": "dropDownWidth"; "icons": "icons"; "inputPurpose": "inputPurpose"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "max": "max"; "messages": "messages"; "min": "min"; "months": "months"; "name": "name"; "opened": "opened"; "placeholder": "placeholder"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "separator": "separator"; "timeFormat": "timeFormat"; "timepicker": "timepicker"; "theme": "theme"; "unfocusable": "unfocusable"; "value": "value"; "valueType": "valueType"; }, { "onChange": "onChange"; }, never>;
}
